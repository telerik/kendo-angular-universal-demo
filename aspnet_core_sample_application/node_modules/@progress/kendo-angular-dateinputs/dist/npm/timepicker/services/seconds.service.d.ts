...
export declare class SecondsService implements ListService {
    ...
    private divideByStep(value);
    private addLast(data, value?);
    private addMissing(data, value);
    private countFromMin(value?);
    private isMissing(value);
    private isLastMissing(value);
    private lastSecond(value?);
    private range(value?);
}
