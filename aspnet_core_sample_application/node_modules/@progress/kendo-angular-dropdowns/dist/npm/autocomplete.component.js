...
var AutoCompleteComponent = (function () {
     ...
     * If you use the `reset` method to clear components value, the model will not update automatically and the `selectionChange` and `valueChange` events will not be fired.
     */
