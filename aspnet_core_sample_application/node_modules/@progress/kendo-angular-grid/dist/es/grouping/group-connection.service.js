...
import { isPresent, isNullOrEmptyString, and, not, or, isUniversal } from '../utils';
...
var GroupConnectionService = (function () {
    ...
    GroupConnectionService.prototype.register = function (target) {
        if (!isUniversal() && isPresent(target)) {
            this.target = target;
        ...
        this.ngzone.runOutsideAngular(function () {
            ...
            _this.subscriptions = draggables.map(function (draggable) {
                ...
                return presses
                    ...
                    .filter(filter)
                    .do(preventDefault)
                    .switchMap(function (x) { return Observable.of(x).delay(150).takeUntil(releases.take(1)); })
