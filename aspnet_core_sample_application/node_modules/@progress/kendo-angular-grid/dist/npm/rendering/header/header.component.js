...
var HeaderComponent = (function () {
    function HeaderComponent(groupDragService, selectionService, popupService) {
    ...
    Object.defineProperty(HeaderComponent.prototype, "showFilterMenu", {
        get: function () {
            return typeof this.filterable === 'string' && this.filterable.indexOf('menu') > -1;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HeaderComponent.prototype, "showFilterRow", {
        get: function () {
            return this.filterable === true || (typeof this.filterable === 'string' && this.filterable.indexOf('row') > -1);
        },
        enumerable: true,
        configurable: true
    });
